...
class ProductCard {
  constructor(id, name, price, shortDescription, fullDescription, image) {
    this.id = id;
    this.name = name;
    this.price = price;
  ...
  showChangeInfo() {
    ...
    modal.modalBodyElem.innerHTML = `
      <form action="changeProduct_obr.php" method="POST" enctype="multipart/form-data" class="change-form">
        ...
        <div class="input-group mb-3">
          ...
          <textarea class="form-control" placeholder="Краткое описание (до 100 символов)" name="short-description">${this.shortDescription}</textarea>
        </div>
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text">@</span>
          </div>
          <textarea rows="10" class="form-control" placeholder="Полное описание" name="full-description">${this.fullDescription}</textarea>
        </div>
